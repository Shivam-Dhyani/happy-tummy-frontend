...
const LandingPage = () => {
  ...
  const { employeesDataStatus } = useSelector((state) => state.all);
        ...
        <>
          ...
          >
            <Container>
              ...
              >
                We are here to take care of your needs, and all we need from you
                in return is your valuable feedback to help us improve this app
                for you!
              </Typography>
              <Box sx={{ mt: 4 }}>
                <Button
